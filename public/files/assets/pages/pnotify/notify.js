...
$(function() {
    ...
    $('#no-internet').on('click', function () {
        new PNotify({
            title: 'No Internet!',
            text: 'Connection time out, Try again.',
            icon: 'icofont icofont-info-circle',
            type: 'default'
        });
    });
    $(document).ready(function() {
        $('#no-internet:first').click();
    })

    // Wrong password notification
    $('#wrong-password').on('click', function () {
        new PNotify({
    ...
    $('#alert-error').on('click', function () {
        new PNotify({
            title: 'Required!',
            text: 'The select file field is required.',
            icon: 'icofont icofont-info-circle',
            type: 'error'
        });
    });
    ...
    $('#user-disable').on('click', function () {
        new PNotify({
            title: 'User does not exist or disable!',
    ...
    $(document).ready(function() {
        $('#upload-success:first').click();
    })

       // Success delete
       $('#delete-success').on('click', function () {
        new PNotify({
            title: 'Success detele!',
            text: 'Excel data delete successfully.',
            icon: 'icofont icofont-check-circled',
            type: 'success'
        });
    });
    ...
    // Success insert
    $('#insert-success').on('click', function () {
        new PNotify({
            title: 'Success insert!',
            text: 'Input data insert successfully.',
            icon: 'icofont icofont-check-circled',
            type: 'success'
        });
    });
    ...
    $('#update-success').on('click', function () {
        new PNotify({
            ...
            text: 'Edit data update successfully.',
            icon: 'icofont icofont-check-circled',
            type: 'success'
        });
    });
    ...
    $(document).ready(function() {
        $('#update-success:first').click();
    })

        // Success update student
        $('#update-student-success').on('click', function () {
            new PNotify({
                title: 'Success update!',
                text: 'Edit data update successfully.',
                icon: 'icofont icofont-check-circled',
        ...
        $(document).ready(function() {
            $('#update-student-success:first').click();
        })

    // Success insert
    $('#insert-student-success').on('click', function () {
        new PNotify({
            title: 'Success insert!',
    ...
    $(document).ready(function() {
        $('#insert-student-success:first').click();
    })
    // delete-success
    $('#deleteStudent-success').on('click', function () {
        new PNotify({
    ...
    $(document).ready(function() {
        $('#deleteStudent-success:first').click();
    })


    // required already exists
    $('#exists-already').on('click', function () {
        new PNotify({
            title: 'Already exists!',
            text: 'Codes already exists.',
            icon: 'icofont icofont-info-circle',
            type: 'error'
        });
    });
