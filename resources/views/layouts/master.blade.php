        ...
        <nav class="navbar header-navbar pcoded-header">
            <div class="navbar-wrapper">
                <div class="navbar-logo">
                    ...
                    <a href="">
                        <img class="img-fluid" src="..\files\assets\images\logo.png" style="width:145px " alt="Theme-Logo">
                    </a>
                ...
                <div class="navbar-container container-fluid">
                        ...
                        <li class="user-profile header-notification">
                            <div class="dropdown-primary dropdown">
                                <div class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="..\files\assets\images\{{$user->avatar}}" class="img-radius" alt="User-Profile-Image">
                                    <span>{{$user->name}}</span>
                    ...
                    <ul class="nav-right"><!-- help end -->
                        <li class="help">
                        <a target="_blank" href="#">
                            <i class="ti-help-alt" style="font-size:18px;"></i> Help</a>
                        </li>
                    </ul><!-- help end -->
                </div>
            </div>
                                                ...
                                                <div class="card-block text-center">
                                                    ...
                                                    <div class="avatar-upload">
                                                        ...
                                                        <div class="avatar-preview">
                                                            <div id="imagePreview" style="background-image: url(../files/assets/images/{{$user->avatar}});"></div>
                                                        </div>
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <h6 class="text-muted f-w-400">{{$user->email}}<a href="#!" class="cf_email" data-cfemail="1379767d6a53747e727a7f3d707c7e"></a></h6>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <p class="m-b-10 f-w-600">Department</p>
                                                        <h6 class="text-muted f-w-400">{{$user->department}}</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <h6 class="text-muted f-w-400">{{$user->division}}</h6>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <p class="m-b-10 f-w-600">Role</p>
                                                        <h6 class="text-muted f-w-400">{{$user->role_name}}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
